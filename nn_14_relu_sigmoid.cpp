...
int main()
{
	...
	char const *neural_network = "nn_14_relu_sigmoid";
	...
	ofstream result_output("./outputs/nn_14_relu_sigmoid.txt");
	...
	plot_setting.plot_2D_interval_MATLAB("nn_14_relu_sigmoid", result);
