...
int main()
{
	...
	char const *neural_network = "nn_18_relu_tanh";
	...
	ofstream result_output("./outputs/nn_18_relu_tanh.txt");
	...
	plot_setting.plot_2D_interval_MATLAB("nn_18_relu_tanh", result);
