...
int main()
{
	...
	setting.setFixedStepsize(0.012, order);
...
//	char const *activation = "ReLU";
	...
	char const *neural_network = "nn_19_sigmoid";
...
*/
	...
	ofstream result_output("./outputs/nn_19_sigmoid.txt");
	...
	plot_setting.plot_2D_interval_MATLAB("nn_19_sigmoid", result);
