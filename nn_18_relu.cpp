...
int main()
{
	...
	char const *neural_network = "nn_18_relu";
	char const *num_partition = "1e-6";
	...
	ofstream result_output("./outputs/nn_18_relu.txt");
	...
	plot_setting.plot_2D_interval_MATLAB("nn_18_relu", result);
