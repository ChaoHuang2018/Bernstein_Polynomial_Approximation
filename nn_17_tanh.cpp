...
int main()
{
	 ...
	 */
	Interval init_x0(0.35, 0.7), init_x1(-0.35, -0.33), init_x2(0.35, 0.37), init_u(0);
	...
	char const *neural_network = "nn_17_tanh";
	...
	ofstream result_output("./outputs/nn_17_tanh.txt");
	...
	plot_setting.plot_2D_interval_MATLAB("nn_17_tanh", result);
