...
def network_output_range_center(d_str, box_str, output_index, activation, nerual_network, num_partition):
    box = ast.literal_eval(box_str)
    output_i = ast.literal_eval(output_index)
...
def network_output_range_radius(d_str, box_str, output_index, activation, nerual_network, num_partition):
    box = ast.literal_eval(box_str)
    output_i = ast.literal_eval(output_index)
    _, output_range = bp.lipschitz(nn_controller_details(nerual_network, activation), box, output_i, activation)
