...
int main()
{
	...
	Expression_AST<Real> deriv_x0("x1+0.5*x2^2");  // theta_r = 0
	 ...
	 */
	Interval init_x0(0.35, 0.45), init_x1(0.25, 0.35), init_x2(0.35, 0.45), init_u(0);
	...
	char const *neural_network = "nn_15_tanh";
	...
	ofstream result_output("./outputs/nn_15_tanh.txt");
	...
	plot_setting.plot_2D_interval_MATLAB("nn_15_tanh", result);
