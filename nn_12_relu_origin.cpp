...
//	char const *activation = "tanh";
	...
	char const *neural_network = "nn_12_relu_origin";
...
*/
	...
	ofstream result_output("./outputs/nn_12_relu_origin.txt");
	...
	plot_setting.plot_2D_interval_MATLAB("nn_12_relu_origin", result);
