...
int main()
{
	...
	char const *function_name1 = "network_output_range_center";
	char const *function_name2 = "network_output_range_radius";
	char const *function_name3 = "network_output_range";
	...
	ofstream result_output("./outputs/interval_relu_tanh.txt");
	...
	plot_setting.plot_2D_interval_MATLAB("interval_relu_tanh", result);
