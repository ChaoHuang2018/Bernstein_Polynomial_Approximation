...
setting.printOff();
	 ...
	 */
	Interval init_x0(0.4,0.45), init_x1(0.3,0.35), init_u(0);
...
//	char const *activation = "tanh";
	...
	char const *neural_network = "nn_14_relu";
...
//	double factor = 2*pi;
	...
	ofstream result_output("./outputs/nn_14_relu.txt");
	...
	plot_setting.plot_2D_interval_MATLAB("nn_14_relu", result);
