...
int main()
{
	...
	char const *neural_network = "nn_13_relu_tanh_100";
	...
	ofstream result_output("./outputs/nn_13_relu_tanh_100.txt");
	...
	plot_setting.plot_2D_interval_MATLAB("nn_13_relu_tanh_100", result);
